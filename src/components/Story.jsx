...
const Story = () => {
  return (
    <section className="py-32 px-6 md:px-20 relative overflow-hidden bg-white">
      {/* Background layer */}
      <div 
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        ...
        <div className="lg:col-span-7 order-1 lg:order-2 relative">
          ...
          <motion.div 
            ...
            className="absolute top-20 -left-10 z-20 bg-blue-dark p-6 rounded shadow-2xl border-l-4 border-blue-light hidden md:block"
          >
            <p className="text-blue-light font-bold heading-font text-4xl leading-none">1985</p>
            <p className="text-pearl/60 text-[8px] uppercase tracking-widest mt-1">Est. Legacy</p>
          </motion.div>
        </div>
      </div>
    </section>
